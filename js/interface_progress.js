...
const EngineFieldsItems = [
    ...
    {id: B_OPERATION,       name: 'B_OPERATION',      item1: 'Operation',         type: 'select',  value: 'BUYSELL',menu: OperationMenu,    title:  "Orders that are allowed in the strategy. BUY : Only Buy Orders, SELL : Only Sell Orders, BUYSELL : Sell and Buy Orders can be executed", events: {onchange: "onchange_strategyproperty (this, event)"}},
    ...
    {id: B_ILOT,            name: 'B_ILOT',          item1: 'Initial Lot',        type: 'float', value: 0.1, min: 0, max: 200, step: 0.01,  title:  "Initial Lot Size of the strategy, If the value is 0, the initial value will be calculated as 2 % of your current account Equity", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_MAXLOT,          name: 'B_MAXLOT',        item1: 'Max Lot',            type: 'float', value: 1,   min: 0, max: 200, step: 0.01,  title:  "Maximum Lots Size allowed to trade in the strategy, If the value is 0 no maximum is applied, it will be the platform max size", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_MAXCOUNT,        name: 'B_MAXCOUNT',      item1: 'Max Count',          type: 'int',   value: 1,   min: 1, max: 500, step: 1,     title:  "Maximum number of not closed trades in the strategy, Example : if this number is 4 we can have a maximum of 4 active Sell Trades and 4 active Buy Trades simultaneously. An active Trade is a trade which has not been closed", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_DIRECTION,       name: 'B_DIRECTION',     item1: 'Direction',          type: 'select',value: 'ANY',   menu: DirectionMenu,       title:  "Direction indicates the placement that is allowed on orders depending on Direction Type", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_DIRECTIONTYPE,   name: 'B_DIRECTIONTYPE', item1: 'Direction Type',     type: 'select',value: 'LEVEL', menu: DirectionTypeMenu,   title:  "Determines the level of trades when the Direction is precised as BACWARD or FORWARD Direction", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_RECOVERYMODE,    name: 'B_RECOVERYMODE',  item1: 'Recovery Mode',      type: 'select',value: 'C',     menu: RecoveryModeMenu,    title:  "Way the volume of trades are calculated", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_RECOVERYVALUE,   name: 'B_RECOVERYVALUE', item1: 'Recovery Value',     type: 'float', value: 1,   min: 0, max: 200,              title:  "Value associated to the Recovery Mode, if Recovery Mode is a multiplier M, the value can be 1.5 or 2 ...", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_PIPSTEP,         name: 'B_PIPSTEP',       item1: 'Pip Step',           type: 'int',   value: 10 ,min: 0, max: 5000,  step: 1,    title:  "Minimum distance in pips between the opening of two consecutive trades. If the value is 0 means no distance is required", events: {onchange: "onchange_strategyproperty (this, event)"}}, 
    {id: B_TIMESTEP,        name: 'B_TIMESTEP',      item1: 'Time Step',          type: 'int',   value: 10 ,min: 0, max: 5000,  step: 1,    title:  "Minimum time in minutes between the opening of two consecutive trades. If the value is 0, no time is applied", events: {onchange: "onchange_strategyproperty (this, event)"}},    
    {id: B_ORDERTYPE,       name: 'B_ORDERTYPE',     item1: 'Order Type',         type: 'select',value: 'MONO',  menu: OrderTypeMenu,       title:  "Only in a BUYSELL Operation. If the value is HEDGE, any sell or any buy Order will be hedged : A Buy and Sell Order will be done instantly. Related Actions BUY, SELL", events: {onchange: "onchange_strategyproperty (this, event)"}},  
    {id: B_KEEPBUYSELL,     name: 'B_KEEPBUYSELL',   item1: 'KeepBuySell',        type: 'select',value: 'FALSE', menu: KeepBuySellMenu,     title:  "Keep Combined Buy and Sell orders for hedged orders (specified in  Orders Type Property). If the value is TRUE it will not exit Buy trades when action Exit Buy is called and will not Exit Sell Trades when Exit Sell is called. Related Actions: EXIT_BUY, EXIT_SELL", events: {onchange: "onchange_strategyproperty (this, event)"}},     
    {id: B_EXITMODE,        name: 'B_EXITMODE',      item1: 'Exit Mode',          type: 'select',value: 'EXITANY', menu: ExitModeMenu,      title:  "Only in a BUYSELL operation mode. It tells if exit of the buy trades should be before sell trades, it can be EXITANY, EXITBUYFIRST or EXITSELLFIRST. <br>Related Actions : EXIT_BUY, EXIT_SELL", events: {onchange: "onchange_strategyproperty (this, event)"}},      
    {id: B_MAXTIME,         name: 'B_MAXTIME',       item1: 'Max Time',           type: 'int',   value: 0, min: 0, max: 25000,  step: 1,    title:  "Maximum time in minutes we allow a strategy to live. if it is 0 no time is applied. When MaxTime is reached the strategy exit automatically if the Profit is positif", events: {onchange: "onchange_strategyproperty (this, event)"}},
    {id: B_HEDGEMAGNITUDE,  name: 'B_HEDGEMAGNITUDE',item1: 'Hedge Weight',       type: 'float', value: 1,min: 0.1,max: 10,  step: 0.1,     title:  "Magnitude of hedging for Buy or Sell trades", events: {onchange: "onchange_strategyproperty (this, event)"}},   
    {id: B_MINPROFIT,       name: 'B_MINPROFIT',     item1: 'Min Profit',         type: 'float', value: 100, min: 0,  max: 32756,           title:  "Minimum Global Profit (buy sell combined) for the strategy to exit. 0 means no minimum is required.Related Action: EXIT", events: {onchange: "onchange_strategyproperty (this, event)"}},   
    {id: B_BUYMINPROFIT,    name: 'B_BUYMINPROFIT',  item1: 'Buy Min Profit',     type: 'float', value: 100, min: 0,  max: 32756,           title:  "Minimum Global Buy Orders Profit for the strategy to exit all buy trades. 0  means no min profit. Related Action: EXIT_BUY", events: {onchange: "onchange_strategyproperty (this, event)"}},   
    {id: B_SELLMINPROFIT,   name: 'B_SELLMINPROFIT', item1: 'Sell Min Profit',    type: 'float', value: 100, min: 0,  max: 32756,           title:  "Minimum Global Sell Orders Profit for the strategy to exit all sell trades. 0  means no min profit. Related Action: EXIT_SELL", events: {onchange: "onchange_strategyproperty (this, event)"}},    
    {id: B_TP,              name: 'B_TP',            item1: 'Take Profit',        type: 'float', value: 0, min: 0,  max: 32756,             title:  "Take profit Amount for the strategy. 0 means no Take Profit : When this amount is reached, it closes all trades", events: {onchange: "onchange_strategyproperty (this, event)"}},               
    {id: B_TS,              name: 'B_TS',            item1: 'Trailing Stop',      type: 'float', value: 0, min: 0,  max: 32756,             title:  "Trailing stop Amount for the strategy. 0 means no Trailing Stop : When this amount is reached, it closes all trades", events: {onchange: "onchange_strategyproperty (this, event)"}},      
    {id: B_SL,              name: 'B_SL',            item1: 'Stop Loss',          type: 'float', value: 0, min: -32756,   max: 0,           title:  "Stop Loss Amount for the  strategy. 0 means no Stop Loss : When this amount is reached, it closes all trades", events: {onchange: "onchange_strategyproperty (this, event)"}},     
    {id: B_BUYTP,           name: 'B_BUYTP',         item1: 'Buy Take Profit',    type: 'float', value: 0, min: 0,  max: 32756,             title:  "Take profit Amount of all Buy Orders for the strategy. 0 means no Buy Take Profit : When this amount is reached, it closes all buy trades", events: {onchange: "onchange_strategyproperty (this, event)"}},          
    {id: B_BUYTS,           name: 'B_BUYTS',         item1: 'Buy Trailing Stop',  type: 'float', value: 0, min: 0,  max: 32756,             title:  "Trailing stop for all Buy Ordersof the strategy. 0 means no Trailing Stop : When this amount is reached , it closes all buy trades", events: {onchange: "onchange_strategyproperty (this, event)"}},        
    {id: B_BUYSL,           name: 'B_BUYSL',         item1: 'Buy Stop Loss',      type: 'float', value: 0, min: -32756,   max: 0,           title:  "Stop Loss Amount for of all Buy Orders.0 means no Buy Stop Loss : When this amount is reached, it closes all buy trades", events: {onchange: "onchange_strategyproperty (this, event)"}},     
    {id: B_SELLTP,          name: 'B_SELLTP',        item1: 'Sell Take Profit',   type: 'float', value: 0, min: 0,  max: 32756,             title:  "Take profit Amount of all Sell Orders for the stragey. 0 means no Sell Take Profit : When this amount is reached, it closes all sell trades", events: {onchange: "onchange_strategyproperty (this, event)"}},           
    {id: B_SELLTS,          name: 'B_SELLTS',        item1: 'Sell Trailing Stop', type: 'float', value: 0, min: 0, max: 32756,              title:  "Trailing stop for all Sell Orders. 0 means no Trailing Stop : When this amount is reached, it closes all Sell trades", events: {onchange: "onchange_strategyproperty (this, event)"}},           
    {id: B_SELLSL,          name: 'B_SELLSL',        item1: 'Sell Stop Loss',     type: 'float', value: 0, min: -32756,   max: 0,           title:  "Stop Loss Amount for of all Sell Orders.0 means no Sell Stop Loss : When this amount is reached, it closes all sell trades", events: {onchange: "onchange_strategyproperty (this, event)"}},           
    {id: B_BUYLOTTP,        name: 'B_BUYLOTTP',      item1: 'Buy  Orders TP',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Take profit in pips for each Buy order. 0 means no Take Profit : Value in Pips and applied to all buy orders", events: {onchange: "onchange_strategyproperty (this, event)"}},  
    {id: B_BUYLOTTS,        name: 'B_BUYLOTTS',      item1: 'Buy  Orders TS',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Trailing stop in pips for each Buy order. 0 means no Trailing Stop : Value in Pips and applied to all buy orders", events: {onchange: "onchange_strategyproperty (this, event)"}},  
    {id: B_BUYLOTSL,        name: 'B_BUYLOTSL',      item1: 'Buy  Orders SL',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Stop Loss in pips for each Buy order. 0 means no Stop Loss  : Value in Pips and applied to all buy orders", events: {onchange: "onchange_strategyproperty (this, event)"}},  
    {id: B_SELLLOTTP,       name: 'B_SELLLOTTP',     item1: 'Sell Orders TP',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Take profit in pips for each Sell order. 0 means no Take Profit : Value in Pips and applied to all Sell orders", events: {onchange: "onchange_strategyproperty (this, event)"}},  
    {id: B_SELLLOTTS,       name: 'B_SELLLOTTS',     item1: 'Sell Orders TS',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Trailing stop in pips for each Sell order. 0 means no Trailing Stop : Value in Pips and applied to all Sell orders", events: {onchange: "onchange_strategyproperty (this, event)"}},     
    {id: B_SELLLOTSL,       name: 'B_SELLLOTSL',     item1: 'Sell Orders SL',     type: 'int',   value: 0, min: 0, max: 1000,  step: 1,     title:  "Stop Loss in pips for each Sell order. 0 means no Stop Stop : Value in Pips and applied to all sell orders", events: {onchange: "onchange_strategyproperty (this, event)"}},

   // {id: B_LEVELPOINT       , recid: -1,  property: 'Level Point',                  value:  ' '}
    
    {id: B_ONEORDERPERBAR,  name: 'B_ONEORDERPERBAR',item1: 'One Order PerBar',   type: 'select',value: 'FALSE',  menu: OneOrderPerBarMenu, title:  "Only one order can be opened on a bar in the expert Time Frame even if the previous order is Opened and Closed on this bar", events: {onchange: "onchange_strategyproperty (this, event)"}},   
]
...
const OperationItems = [
    ...
    { id:214,text: 'Close Hedge',        name: 'CLOSE_HEDGE',      tooltip :  "Close all Hedges for the session"},
    { id:212,text: 'Close Hedge Buy',    name: 'CLOSE_HEDGE_BUY',  tooltip :  "Close Hedge Buy"},    
    { id:213,text: 'Close Hedge Sell',   name: 'CLOSE_HEDGE_SELL', tooltip :  "Close Hedge Sell"}  
]; 
