...
!function(n) {
    ...
    function Lt(n) {
        ...
        var t = n.oClasses
          ...
          , l = P("<div/>", {
            ...
            class: t.sFilter
            }).append('<label class= "sb_sidebarheadertitle sb_label"></label>',
                      '<div class="sb_end"></div>',
                      P("<span/>", {
                      class: "sb_link sb_search",
                      title: "Search", 
                }).append(P("<label/>", {
                          class: "sb_label",
                          html:  r.sSearch,            
    ...
    P.extend(C.ext.classes, {
        ...
        sWrapper: "sb_panel sb_column sb_main dataTables_wrapper",
        sFilter: "sb_bar dataTables_filter",
        sInfo: "sb_bar dataTables_info",
        ...
        sLengthSelect: "",
        sScrollWrapper: "sb_main dataTables_scroll",
