...
//--------------PROPERTIES ------------------------------
    ...
    Set_Rule(OP_BUYSELL, T_ILOT, R_D, P_SIGNAL, 1);
    ...
    Set_Rule(OP_BUYSELL, T_BUYLOTTP, R_D, P_SIGNAL, 5);
    Set_Rule(OP_BUYSELL, T_BUYLOTSL, R_D, P_SIGNAL, 10);
    Set_Rule(OP_EXIT_BUY, T_MINPROFIT, R_D, P_SIGNAL, -1);
    Set_Rule(OP_BUYSELL, T_SELLLOTTS, R_D, P_SIGNAL, 0);
    Set_Rule(OP_BUYSELL, T_SELLLOTTP, R_D, P_SIGNAL, 5);
    Set_Rule(OP_BUYSELL, T_SELLLOTSL, R_D, P_SIGNAL, 10);
...
//
//--------------ACTIONS ------------------------------
    if (Total_NbrTrades_0 (OP_BUYSELL, R_D))
    {
