...
/* ============================================================
STRATEGY : Prop_Trading_Strategy
RULE : C
DESCRIPTION
...
//--------------PROPERTIES ------------------------------
    ...
    Set_Rule(OP_BUY, T_RECOVERYMODE, R_C, P_SIGNAL, M_C);
    Set_Rule(OP_BUY, T_RECOVERYVALUE, R_C, P_SIGNAL, 1);
    Set_Rule(OP_BUY, T_ILOT, R_C, P_SIGNAL, 0.1);
    Set_Rule(OP_BUY, T_MAXLOT, R_C, P_SIGNAL, 1);
    Set_Rule(OP_BUY, T_MAXCOUNT, R_C, P_SIGNAL, 1);
...
//--------------ACTIONS ------------------------------
//--------------END ACTIONS ------------------------------
    if ((Candle_Hammer_H1 (OP_BUY, R_C) && (AndS( || AndS()))
{}
//
//
//------------------------------ SELL ENGINE ------------------------------
...
Set_Rule(OP_SELL, T_RECOVERYMODE, R_C, P_SIGNAL, M_C);
Set_Rule(OP_SELL, T_RECOVERYVALUE, R_C, P_SIGNAL, 1);
Set_Rule(OP_SELL, T_ILOT, R_C, P_SIGNAL, 0.1);
Set_Rule(OP_SELL, T_MAXLOT, R_C, P_SIGNAL, 1);
Set_Rule(OP_SELL, T_MAXCOUNT, R_C, P_SIGNAL, 1);
