...
//--------------END ACTIONS ------------------------------
    if (((AndS(HEIKEN_ASHI, S_BULL, P_W1) && AndS(HEIKEN_ASHI, S_BULL, P_D1) && AndS(RSI_20, S_ABOVE, P_D1)) && (AndBS(HEIKEN_ASHI, S_BULL, P_D1) || AndBS(RSI_20, S_ABOVE, P_D1))))
    {
        Set_Rule(OP_BUYSELL, T_START, R_M, P_SIGNAL);
        Set_Rule(OP_BUY, T_STATUS, R_M, P_SIGNAL);
    }
    if (((AndS(HEIKEN_ASHI, S_BEAR, P_W1) && AndS(HEIKEN_ASHI, S_BEAR, P_D1) && AndS(RSI_20, S_BELOW, P_D1)) && (AndBS(HEIKEN_ASHI, S_BEAR, P_D1) || AndBS(RSI_20, S_BELOW, P_D1))))
    {
        Set_Rule(OP_BUYSELL, T_START, R_M, P_SIGNAL);
