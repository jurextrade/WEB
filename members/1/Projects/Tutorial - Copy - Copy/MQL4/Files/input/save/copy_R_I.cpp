...
//--------------PROPERTIES ------------------------------
    ...
    Set_Rule(OP_BUYSELL, T_RECOVERYMODE, R_I, P_SIGNAL, M_Q);
    ...
    Set_Rule(OP_BUYSELL, T_BUYLOTTP, R_I, P_SIGNAL, 5);
    Set_Rule(OP_BUYSELL, T_BUYLOTSL, R_I, P_SIGNAL, 5);
    Set_Rule(OP_EXIT_BUY, T_MINPROFIT, R_I, P_SIGNAL, -1);
    Set_Rule(OP_BUYSELL, T_SELLLOTTS, R_I, P_SIGNAL, 0);
    Set_Rule(OP_BUYSELL, T_SELLLOTTP, R_I, P_SIGNAL, 5);
    Set_Rule(OP_BUYSELL, T_SELLLOTSL, R_I, P_SIGNAL, 5);
