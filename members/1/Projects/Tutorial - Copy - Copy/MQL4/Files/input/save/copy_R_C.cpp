...
//
//--------------PROPERTIES ------------------------------
    Set_Rule(OP_BUYSELL, T_DIRECTION, R_C, P_SIGNAL, D_ANY);
    Set_Rule(OP_BUYSELL, T_DIRECTIONTYPE, R_C, P_SIGNAL, DT_LEVEL);
    Set_Rule(OP_BUYSELL, T_RECOVERYMODE, R_C, P_SIGNAL, M_C);
    Set_Rule(OP_BUYSELL, T_RECOVERYVALUE, R_C, P_SIGNAL, 1);
    Set_Rule(OP_BUYSELL, T_ILOT, R_C, P_SIGNAL, 0.2);
    Set_Rule(OP_BUYSELL, T_MAXLOT, R_C, P_SIGNAL, 1);
    ...
    Set_Rule(OP_BUYSELL, T_PIPSTEP, R_C, P_SIGNAL, 10);
    Set_Rule(OP_BUYSELL, T_TIMESTEP, R_C, P_SIGNAL, 10);
    ...
    Set_Rule(OP_BUYSELL, T_TS, R_C, P_SIGNAL, 0);
    Set_Rule(OP_BUYSELL, T_TP, R_C, P_SIGNAL, 0);
    Set_Rule(OP_BUYSELL, T_SL, R_C, P_SIGNAL, 0);
    ...
    Set_Rule(OP_EXIT, T_MINPROFIT, R_C, P_SIGNAL, 40);
//--------------END PROPERTIES ------------------------------
//
//
//--------------ACTIONS ------------------------------
...
//--------------END ACTIONS ------------------------------
    if ((Candle_Buy_Entry_H4 (OP_BUYSELL, R_C) && Candle_Buy_Entry_D1 (OP_BUYSELL, R_C)))
    {
        Set_Rule(OP_BUYSELL, T_START, R_C, P_SIGNAL);
        Set_Rule(OP_BUY, T_STATUS, R_C, P_SIGNAL);
    }
    if ((Candle_Sell_Entry_D1 (OP_BUYSELL, R_C) && Candle_Sell_Entry_H4 (OP_BUYSELL, R_C)))
    {
        Set_Rule(OP_BUYSELL, T_START, R_C, P_SIGNAL);
        Set_Rule(OP_SELL, T_STATUS, R_C, P_SIGNAL);
    }
    if (Candle_Buy_Exit_H1 (OP_BUYSELL, R_C))
    {
        Set_Rule(OP_CLOSE_BUY, T_STATUS, R_C, P_SIGNAL);
    }
    if (Candle_Sell_Exit_H1 (OP_BUYSELL, R_C))
    {
