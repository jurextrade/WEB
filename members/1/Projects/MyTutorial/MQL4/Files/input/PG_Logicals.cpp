...
double _FindClosestPivot  (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule, int way, double value, double min) 
{
	double Tab[27];
	int i = 0;

		Tab[i] = SValue(PIVOT_POINT, S_CURRENT, P_D1); i++; 
		Tab[i] = SValue(PIVOT_POINT, S_PREVIOUS, P_D1); i++; 
		Tab[i] = SPValue(PIVOT_POINT, S_PREVIOUS, P_D1); i++; 
		
		Tab[i] = SValue(PIVOT_RESISTANCE, S_CURRENT, P_D1); i++; 
		Tab[i] = SValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1); i++;
		Tab[i] = SPValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1); i++;
		Tab[i] = SValue(PIVOT_RESISTANCE1, S_CURRENT, P_D1); i++;
		Tab[i] = SValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1); i++;
		Tab[i] = SPValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1); i++;
		Tab[i] = SValue(PIVOT_RESISTANCE2, S_CURRENT, P_D1); i++;
		Tab[i] = SValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1); i++;
		Tab[i] = SPValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1); i++;
		Tab[i] = SValue(PIVOT_HIGH, S_CURRENT, P_D1); i++;
		Tab[i] = SValue(PIVOT_HIGH, S_PREVIOUS, P_D1); i++;
		Tab[i] = SPValue(PIVOT_HIGH, S_PREVIOUS, P_D1); i++;

		Tab[i] = SValue(PIVOT_SUPPORT, S_CURRENT, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SPValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_SUPPORT1, S_CURRENT, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SPValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_SUPPORT2, S_CURRENT, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SPValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1);  i++; 
		Tab[i] = SValue(PIVOT_LOW, S_CURRENT, P_D1); i++;
		Tab[i] = SValue(PIVOT_LOW, S_PREVIOUS, P_D1); i++;
		Tab[i] = SPValue(PIVOT_LOW, S_PREVIOUS, P_D1); i++;

        if (way == 1) {
		    for (i = 0; i < 27; i++)
		        if ((Tab[i] - min/Point) > value) 
				    return ((Tab[i] - value)/ Point); 
        }
        else {
		    for (i = 26; i >= 0; i--)
		        if ((Tab[i] + min/Point) < value) 
				    return ((value - Tab[i]) / Point); 
        }
...
bool _Prev_Narrow_day (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (((SValue(PIVOT_HIGH, S_CURRENT, P_D1) - SValue(PIVOT_LOW, S_CURRENT, P_D1)) / Point) <= 10);
}
bool _Breakout_Big_Candle_M15_Bull (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Breakout_Big_Candle_M15_Bear (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _velocity_up (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Momentum_is_bull (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Momentum_is_bear (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Sell_Entry_H4 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Buy_Exit_H4 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Sell_Exit_H4 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Buy_Entry_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Sell_Entry_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Buy_Exit_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (!Trade_no (Operation, Rule) && (Candle_Bear_Changed_H1 (Operation, Rule) || AndS(LOW, S_BELOW, P_H1)));
}
bool _Candle_Sell_Exit_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Sell_Entry_M30 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Buy_Exit_M30 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Trade_Buy_Candle (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _FractalUp_Approaching_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Buy_Exit_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _FractalDown_Approaching_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((SValue(DOWNFRACTAL, S_DISTANCE, P_H1) < (5 * Point)) && (SValue(DOWNFRACTAL, S_DISTANCE, P_H1) > 0));
}
bool _FractalUp_Approaching_H4 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((SValue(UPFRACTAL, S_DISTANCE, P_H4) > (-5 * Point)) && (SValue(UPFRACTAL, S_DISTANCE, P_H4) < 0));
}
bool _FractalDown_Approaching_H4 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((SValue(DOWNFRACTAL, S_DISTANCE, P_H4) < (5 * Point)) && (SValue(DOWNFRACTAL, S_DISTANCE, P_H4) > 0));
}
bool _FractalDown_Approaching_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((SValue(DOWNFRACTAL, S_DISTANCE, P_D1) < (5 * Point)) && (SValue(DOWNFRACTAL, S_DISTANCE, P_D1) > 0));
}
bool _FractalUp_Approaching_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((SValue(UPFRACTAL, S_DISTANCE, P_D1) > (-5 * Point)) && (SValue(UPFRACTAL, S_DISTANCE, P_D1) < 0));
}
bool _FractalUp_Approaching (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Gap_Down_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (SValue(OPEN, S_CURRENT, P_D1) < (SValue(CLOSE, S_PREVIOUS, P_D1) - (5 * Point)));
}
bool _Gap_Up_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (SValue(OPEN, S_CURRENT, P_D1) > (SValue(CLOSE, S_PREVIOUS, P_D1) + (5 * Point)));
}
bool _Candle_Bull_Changed_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((((SValue(LOW, S_CURRENT, P_H1) - SValue(CLOSE, S_CURRENT, P_H1)) / Point) < -5) && AndTS(BAR, S_BULL, P_H1));
}
bool _Candle_Bear_Changed_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((((SValue(HIGH, S_CURRENT, P_H1) - SValue(CLOSE, S_CURRENT, P_H1)) / Point) > 5) && AndTS(BAR, S_BEAR, P_H1));
}
bool _Pivot_Up_Approaching_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Pivot_Down_Approaching_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Trade_Buy_OnBar_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((RValue (Operation, T_LASTORDEROPENTIME, Rule) > STime(BAR, S_CURRENT, P_H1)) && (RValue (Operation, T_LASTORDERTYPE, Rule) == 0));
}
bool _Trade_Sell_OnBar_H1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((RValue (Operation, T_LASTORDEROPENTIME, Rule) > STime(BAR, S_CURRENT, P_H1)) && (RValue (Operation, T_LASTORDERTYPE, Rule) == 1));
}
bool _Candle_Min_Size (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((fabs(SValue(BAR, S_CURRENT, P_H1)) / Point) > 5);
}
bool _ShouldExit (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (CurrentTime > ReturnTime("22:00:00"));
}
bool _ShouldStart (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((CurrentTime < ReturnTime("22:00:00")) && (CurrentTime > ReturnTime("02:00:00")));
}
bool _Fractal_Up_Zone (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return OrS(UPFRACTAL, S_ALERT, P_M30, P_H1, P_H4, P_D1);
}
bool _Fractal_Down_Zone (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return OrS(DOWNFRACTAL, S_ALERT, P_M30, P_H1, P_H4, P_D1);
}
bool _Pivot_Down_Zone (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Pivot_Up_Zone (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Candle_Hammer_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (AndS(BAR, S_BULL_HAMMER1, P_D1) || AndS(BAR, S_BULL_HAMMER2, P_D1));
}
bool _Candle_ShootingStar_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
...
bool _Prev_Bear_PinBar (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (AndPS(BAR, S_BEAR_SHOOTING_STAR, P_H1) || AndPS(BAR, S_BEAR_SHOOTING_STAR1, P_H1) || AndPS(BAR, S_BEAR_SHOOTING_STAR2, P_H1));
}
bool _Prev_Bull_PinBar (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (AndPS(BAR, S_BULL_HAMMER, P_H1) || AndPS(BAR, S_BULL_HAMMER1, P_H1) || AndPS(BAR, S_BULL_HAMMER2, P_H1));
}
bool _Prev_Bar_Intersect_Upper_Pivots (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_POINT, S_CURRENT, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_POINT, S_CURRENT, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_POINT, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_POINT, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_POINT, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_POINT, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE, S_CURRENT, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE, S_CURRENT, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_RESISTANCE, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE1, S_CURRENT, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE1, S_CURRENT, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_RESISTANCE1, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE2, S_CURRENT, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE2, S_CURRENT, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_RESISTANCE2, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_HIGH, S_CURRENT, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_HIGH, S_CURRENT, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_HIGH, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_HIGH, S_PREVIOUS, P_D1))) || ((SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_HIGH, S_PREVIOUS, P_D1)) && (SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_HIGH, S_PREVIOUS, P_D1))));
}
bool _Prev_Bar_Intersect_Lower_Pivots (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_POINT, S_CURRENT, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_POINT, S_CURRENT, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_POINT, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_POINT, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_POINT, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_POINT, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT, S_CURRENT, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT, S_CURRENT, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_SUPPORT, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT1, S_CURRENT, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT1, S_CURRENT, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_SUPPORT1, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT2, S_CURRENT, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT2, S_CURRENT, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_SUPPORT2, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_LOW, S_CURRENT, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_LOW, S_CURRENT, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SValue(PIVOT_LOW, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SValue(PIVOT_LOW, S_PREVIOUS, P_D1))) || ((SValue(LOW, S_PREVIOUS, P_H1) <= SPValue(PIVOT_LOW, S_PREVIOUS, P_D1)) && (SValue(HIGH, S_PREVIOUS, P_H1) >= SPValue(PIVOT_LOW, S_PREVIOUS, P_D1))));
}
bool _Engulfing_BEAR_H1_H4_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return OrS(BAR, S_BEAR_ENGULFING, P_H1, P_H4, P_D1);
}
bool _Engulfing_BULL_H1_H4_D1 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return OrS(BAR, S_BULL_ENGULFING, P_H1, P_H4, P_D1);
}
bool _Momentum_BEAR (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (SValue(Momentum, S_CURRENT, P_H1) < 99.5);
}
bool _Momentum_BULL (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (SValue(Momentum, S_CURRENT, P_H1) > 100.5);
}
bool _Total_NbrTrades_0 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return ((0 == RValue (Operation, T_BUYNBRTRADE, Rule)) && (0 == RValue (Operation, T_SELLNBRTRADE, Rule)));
}
bool _Time_More_2340 (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (CurrentTime > ReturnTime("23:40:59"));
}
bool _CROSS_DOWN_CLOSE_D1_PREVIOUS_BEAR (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
	return (AndPS(BAR, S_BEAR, P_D1) && AndS(CLOSE, S_CROSS_DOWN, P_D1));
}
bool _CROSS_UP_CLOSE_D1_PREVIOUS_BULL (double Ask, double Bid, datetime CurrentTime, int CurrentPeriod, std::string Symbol, double Point, double Digits, int* SignalTab, double* SignalTabValue, datetime*	SignalTabTime, double* SignalTabPrice, int* BeforeSignalTab, double* BeforeSignalTabValue, datetime* BeforeSignalTabTime, double* BeforeSignalTabPrice,int* BeforeSignalTickTab, int* RuleTab, double* RuleTabValue, int* BeforeRuleTab, double* BeforeRuleTabValue, int Operation, int Rule) 
{
