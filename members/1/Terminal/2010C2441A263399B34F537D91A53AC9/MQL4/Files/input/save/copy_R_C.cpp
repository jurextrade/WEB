...
//--------------PROPERTIES ------------------------------
    ...
    Set_Rule(OP_BUY, T_MAXLOT, R_C, P_SIGNAL, 3.2);
    Set_Rule(OP_BUY, T_MAXCOUNT, R_C, P_SIGNAL, 6);
    ...
    Set_Rule(OP_BUY, T_TIMESTEP, R_C, P_SIGNAL, 5);
    ...
    Set_Rule(OP_BUY, T_TS, R_C, P_SIGNAL, 10);
...
//
//--------------ACTIONS ------------------------------
    if (Engulfing_BULL_H1_H4_D1 (OP_BUY, R_C))
    {
...
//
//--------------ACTIONS ------------------------------
    if (Engulfing_BEAR_H1_H4_D1 (OP_SELL, R_C))
    {
