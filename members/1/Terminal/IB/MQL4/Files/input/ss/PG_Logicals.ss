...
(defun Candle_Hammer_H1 () 
(OR (AndPS BAR S_BULL_HAMMER1 P_H1)
 (AndPS BAR S_BULL_HAMMER2 P_H1)
 (AndPS BAR S_BULL_HAMMER P_H1)
)
)
(defun Candle_ShootingStar_H1 () 
(OR (AndPS BAR S_BEAR_SHOOTING_STAR1 P_H1)
 (AndPS BAR S_BEAR_SHOOTING_STAR2 P_H1)
 (AndPS BAR S_BEAR_SHOOTING_STAR P_H1)
)
)
(defun Prev_Bear_PinBar () 
(OR (AndPS BAR S_BEAR_SHOOTING_STAR P_H1)
 (AndPS BAR S_BEAR_SHOOTING_STAR1 P_H1)
 (AndPS BAR S_BEAR_SHOOTING_STAR2 P_H1)
)
)
(defun Prev_Bull_PinBar () 
(OR (AndPS BAR S_BULL_HAMMER P_H1)
 (AndPS BAR S_BULL_HAMMER1 P_H1)
 (AndPS BAR S_BULL_HAMMER2 P_H1)
)
)
(defun Prev_Bar_Intersect_Upper_Pivots () 
...
(defun Prev_Bar_Intersect_Lower_Pivots () 
(OR (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_POINT S_CURRENT P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_POINT S_CURRENT P_D1)
)
)
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_POINT S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_POINT S_PREVIOUS P_D1)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT S_CURRENT P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT S_CURRENT P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT1 S_CURRENT P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT1 S_CURRENT P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT1 S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT1 S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT1 S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT1 S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT2 S_CURRENT P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT2 S_CURRENT P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT2 S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_SUPPORT2 S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT2 S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SPValue PIVOT_SUPPORT2 S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SValue PIVOT_LOW S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SValue PIVOT_LOW S_PREVIOUS P_D1)
)
 ...
 (AND (<= (SValue LOW S_PREVIOUS P_H1)
 (SPValue PIVOT_LOW S_PREVIOUS P_D1)
)
 (>= (SValue HIGH S_PREVIOUS P_H1)
 (SPValue PIVOT_LOW S_PREVIOUS P_D1)
)
